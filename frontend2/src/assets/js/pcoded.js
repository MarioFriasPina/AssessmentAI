...
function layout_change(layout) {
  ...
  if (layout == 'dark') {
    ...
    if (document.querySelector('.pc-sidebar .m-header .logo-lg')) {
      document.querySelector('.pc-sidebar .m-header .logo-lg').setAttribute('src', '../assets/images/igdrasil.png');
    }
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function setTheme(theme) {
    ...
    if (theme === 'dark') {
      ...
      //como cambiar el color del icono
      icon.style.color = '#1890ff'; // Cambia el color del icono a blanco en modo oscuro
    } else {
      icon.classList.remove('ti-moon');
      // Cambia el color del
      icon.style.color = ''; // Restablece el color del icono al predeterminado en modo claro
  ...
  // Escuchar cambio en preferencia sistema y actualizar automáticamente si no hay preferencia guardada
